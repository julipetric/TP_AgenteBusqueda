...
public class Comprar45 extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[4][5] != Double.MAX_VALUE);
		boolean p2 = (agState.getposicionActual() == 4);
		boolean p3 = (!agState.getlistaProductos().contains(5));
		boolean p4 = (agState.getlistaProductosDeseados().contains(5));
		boolean p5 = (agState.getposicionActual() != -1);
		boolean p = (p1 && p2 && p3 && p4 && p5);

		if (p) {
			agState.getlistaProductos().add(5);
			return agState;
		}
		return null;
	}
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[4][5];
			break;
