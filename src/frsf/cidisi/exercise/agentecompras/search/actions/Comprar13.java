...
public class Comprar13 extends SearchAction {

	EstadoAgente agState;
	/**
	 * This method updates a tree node state when the search process is running. 1t
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[1][3] != Double.MAX_VALUE);
		boolean p2 = (agState.getposicionActual() == 1);
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[1][3];
			break;
