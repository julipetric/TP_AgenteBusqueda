...
public class Moverse2 extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// PreConditions
		boolean p = (agState.getposicionActual() != 2);

		if (p) {
			agState.setposicionPrevia(agState.getposicionActual());
			agState.setposicionActual(2);
	...
	public Double getCost() {
		...
		if (agState.getposicionPrevia() != -1) {
			...
			case 0:
				...
				// Bici
				case 1:
					t = (Double) (double) agState.getmapaTiempo()[0][agState.getposicionPrevia()][2];
					break;
				case 2:
					t = (Double) (double) agState.getmapaTiempo()[1][agState.getposicionPrevia()][2];
					break;
				case 3:
					t = (Double) (double) agState.getmapaTiempo()[2][agState.getposicionPrevia()][2];
					break;
				}
				break;
			// Costo
			case 1:
				...
				// Auto
				case 2:
					t = (Double) (double) agState.getmapaDist()[1][agState.getposicionPrevia()][2];
					t = t * agState.getprecioNafta();
					break;
				case 3:
					t = (Double) (double) agState.getmapaDist()[2][agState.getposicionPrevia()][2];
			...
			case 2:
				...
				case 2:
					t = (Double) (double) agState.getmapaDist()[1][agState.getposicionPrevia()][2];
					t = t * agState.getprecioNafta();
					t = t / (Double) (double) agState.getmapaTiempo()[1][agState.getposicionPrevia()][2];
					break;
				case 3:
					t = (Double) (double) agState.getmapaDist()[2][agState.getposicionPrevia()][2];
					t = t * agState.getprecioTransportePublico();
					t = t / (Double) (double) agState.getmapaTiempo()[2][agState.getposicionPrevia()][2];
					break;
				}
				break;
			}
			...
			case 0:
				...
				// Bici
				case 1:
					t = (Double) (double) agState.gettiemposOrigen()[0][2];
					break;
				case 2:
					t = (Double) (double) agState.gettiemposOrigen()[1][2];
					break;
				case 3:
					t = (Double) (double) agState.gettiemposOrigen()[2][2];
					break;
				}
				break;
			// Costo
			case 1:
				...
				// Auto
				case 2:
					t = (Double) (double) agState.getdistanciasOrigen()[1][2];
					t = t * agState.getprecioNafta();
					break;
				case 3:
					t = (Double) (double) agState.getdistanciasOrigen()[2][2];
					t = t * agState.getprecioTransportePublico();
					break;
				}
				break;
			...
			case 2:
				...
				case 2:
					t = (Double) (double) agState.getdistanciasOrigen()[1][2];
					t = t * agState.getprecioNafta();
					t = t / (Double) (double) agState.gettiemposOrigen()[1][2];
					break;
				case 3:
					t = (Double) (double) agState.getdistanciasOrigen()[2][2];
					t = t * agState.getprecioTransportePublico();
					t = t / (Double) (double) agState.gettiemposOrigen()[2][2];
					break;
				}
				break;
			}
