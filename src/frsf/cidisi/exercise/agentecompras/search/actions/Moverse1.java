...
public class Moverse1 extends SearchAction {
	...
	public Double getCost() {
		...
		if (agState.getposicionPrevia() != -1) {
			...
			case 0:
				...
				// Bici
				case 1:
					t = (Double) (double) agState.gettiemposOrigen()[0][1];
					break;
				case 2:
					t = (Double) (double) agState.gettiemposOrigen()[1][1];
					break;
				case 3:
					t = (Double) (double) agState.gettiemposOrigen()[2][1];
					break;
				}
				break;
			// Costo
			case 1:
				...
				// Auto
				case 2:
					t = (Double) (double) agState.getdistanciasOrigen()[1][1];
					t = t * agState.getprecioNafta();
					break;
				case 3:
					t = (Double) (double) agState.getdistanciasOrigen()[2][1];
					t = t * agState.getprecioTransportePublico();
					break;
				}
				break;
			...
			case 2:
				...
				case 2:
					t = (Double) (double) agState.getdistanciasOrigen()[1][1];
					t = t * agState.getprecioNafta();
					t = t / (Double) (double) agState.gettiemposOrigen()[1][1];
					break;
				case 3:
					t = (Double) (double) agState.getdistanciasOrigen()[2][1];
					t = t * agState.getprecioTransportePublico();
					t = t / (Double) (double) agState.gettiemposOrigen()[2][1];
					break;
				}
				break;
			}
