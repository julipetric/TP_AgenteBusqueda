...
public class Comprar33 extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[3][3] != Double.MAX_VALUE);
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[3][3];
			break;
