...
public class Comprar20 extends SearchAction {

	EstadoAgente agState;
	/**
	 * This method updates a tree node state when the search process is running. 2t
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[2][0] != Double.MAX_VALUE);
		boolean p2 = (agState.getposicionActual() == 2);
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[2][0];
			break;
