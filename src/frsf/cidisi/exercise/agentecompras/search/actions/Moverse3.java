	...
	public Double getCost() {
		...
		if (agState.getposicionActual() != -1) {
			...
			case 0:
				...
				// Bici
				case 1:
					t = (Double) (double) agState.getmapaTiempo()[0][agState.getposicionActual()][3];
					break;
				case 2:
					t = (Double) (double) agState.getmapaTiempo()[1][agState.getposicionActual()][3];
					break;
				case 3:
					t = (Double) (double) agState.getmapaTiempo()[2][agState.getposicionActual()][3];
					break;
				}
				break;
			// Costo
			case 1:
				...
				// Auto
				case 2:
					t = (Double) (double) agState.getmapaDist()[1][agState.getposicionActual()][3];
			...
			case 2:
				...
				case 2:
					t = (Double) (double) agState.getmapaDist()[1][agState.getposicionActual()][3];
					t = t * agState.getprecioNafta();
					t = t / (Double) (double) agState.getmapaTiempo()[1][agState.getposicionActual()][3];
					break;
				case 3:
					t = (Double) (double) agState.getmapaDist()[1][agState.getposicionActual()][3];
					t = t * agState.getprecioTransportePublico();
					t = t / (Double) (double) agState.getmapaTiempo()[2][agState.getposicionActual()][3];
					break;
				}
				break;
			}
