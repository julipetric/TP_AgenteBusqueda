...
public class Comprar35 extends SearchAction {
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[3][5] != Double.MAX_VALUE);
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[3][5];
			break;
