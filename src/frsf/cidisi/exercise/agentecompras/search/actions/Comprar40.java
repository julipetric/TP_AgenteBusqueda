...
public class Comprar40 extends SearchAction {

	EstadoAgente agState;
	/**
	 * This method updates a tree node state when the search process is running. 4t
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		// Preconditions
		boolean p1 = (agState.getpreciosProductosComercios()[4][0] != Double.MAX_VALUE);
		boolean p2 = (agState.getposicionActual() == 4);
		boolean p3 = (!agState.getlistaProductos().contains(0));
		boolean p4 = (agState.getlistaProductosDeseados().contains(0));
		boolean p5 = (agState.getposicionActual() != -1);
		boolean p = (p1 && p2 && p3 && p4 && p5);

		if (p) {
			agState.getlistaProductos().add(0);
			return agState;
		}
		return null;
	}
	...
	public Double getCost() {
		...
		// Costo
		case 1:
			p = agState.getpreciosProductosComercios()[4][0];
			break;
