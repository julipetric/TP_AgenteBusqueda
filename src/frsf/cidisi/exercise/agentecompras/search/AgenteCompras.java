...
public class AgenteCompras extends SearchBasedAgent {
	...
	public AgenteCompras() {
		...
		/*
		 * operators.addElement(new Moverse2()); operators.addElement(new Moverse3());
		 * operators.addElement(new Moverse4());
		 */
		operators.addElement(new Comprar00());
		operators.addElement(new Comprar01());
		/*
		 * operators.addElement(new Comprar02()); operators.addElement(new Comprar03());
		 * operators.addElement(new Comprar04()); operators.addElement(new Comprar05());
		 * operators.addElement(new Comprar10()); operators.addElement(new Comprar11());
		 * operators.addElement(new Comprar12()); operators.addElement(new Comprar13());
		 * operators.addElement(new Comprar14()); operators.addElement(new Comprar15());
		 * operators.addElement(new Comprar20()); operators.addElement(new Comprar21());
		 * operators.addElement(new Comprar23()); operators.addElement(new Comprar23());
		 * operators.addElement(new Comprar24()); operators.addElement(new Comprar25());
		 * operators.addElement(new Comprar30()); operators.addElement(new Comprar31());
		 * operators.addElement(new Comprar32()); operators.addElement(new Comprar33());
		 * operators.addElement(new Comprar34()); operators.addElement(new Comprar35());
		 * operators.addElement(new Comprar40()); operators.addElement(new Comprar41());
		 * operators.addElement(new Comprar42()); operators.addElement(new Comprar43());
		 * operators.addElement(new Comprar44()); operators.addElement(new Comprar45());
		 */
